    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
        	...
        	case 2: System.out.println("Enter a keyword:");
            		...
            		if (key_input1.length() % 2 == 0)
            		{
            			 System.out.println("Encryption: " + x.encryptMessage(key_input1));
            			
            			 System.out.println("Decryption: "+ x.decryptMessage(x.encryptMessage(key_input1)));
            		}
            		else
            		{
            			System.out.println("Message length should be even");
